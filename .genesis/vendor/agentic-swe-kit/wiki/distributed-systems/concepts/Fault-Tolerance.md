...
## Checkpoint plus Message Logging Recovery Combines periodic state snapshots with
...
## Dependability Framework Four property model Availability Reliability Safety Main
...
## Failure Taxonomy Hierarchical classification of faultserrorsfailures with five p
...
## Paxos Consensus Algorithm A fault tolerant consensus protocol requiring 2k1 serv
...
## Process Group Resilience Multiple identical processes cooperate to appear as a s
...
## Virtual Synchrony Model Execution model that introduces epoch boundaries within
