...
# Coordination and Clocks

> Consolidated from 5 related concept pages.

---

## Clock Synchronization All distributed clock sync methods exchange clock values w
...
## Distributed Mutual Exclusion Algorithms ensuring at most one process at a time a
...
## Election Algorithms Protocols by which a group of distributed processes collecti
...
## Lamport Logical Clocks Each event e is assigned a globally unique logical timest
...
## Vector Timestamps An extension of Lamport timestamps where Ca Cb implies event a
