...
## Causal Consistency operations that are potentially causally dependent on each ot
...
## Client Centric Consistency Models ensures a single possibly mobile client always
...
## Data Centric Consistency Models defines consistency guarantees in terms of what
...
## Sequential Consistency all write operations are seen by everyone in the same ord
