...
## Primary Based Protocols all update operations are forwarded to a primary copy th
...
## Replicated Write Protocols updates are forwarded to several replicas simultaneou
