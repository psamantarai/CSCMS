---
title: Open vs. Closed Group Model: A framework for managing node membership — open groups allow any node to join and message freely; closed groups require explicit admission control and authentication
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Open vs. Closed Group Model: A framework for managing node membership — open groups allow any node to join and message freely; closed groups require explicit admission control and authentication
