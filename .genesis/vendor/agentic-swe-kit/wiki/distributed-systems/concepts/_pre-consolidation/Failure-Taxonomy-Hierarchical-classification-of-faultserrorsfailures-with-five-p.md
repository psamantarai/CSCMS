---
title: Failure Taxonomy: Hierarchical classification of faults→errors→failures with five process-level failure types: crash, omission, timing, response, and Byzantine/arbitrary
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Failure Taxonomy: Hierarchical classification of faults→errors→failures with five process-level failure types: crash, omission, timing, response, and Byzantine/arbitrary
