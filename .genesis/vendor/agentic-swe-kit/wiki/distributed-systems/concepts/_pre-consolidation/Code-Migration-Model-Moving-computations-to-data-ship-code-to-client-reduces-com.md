---
title: Code Migration Model: Moving computations to data (ship code to client) reduces communication cost; two drivers are performance (reduce remote calls) and flexibility (dynamic client configuration without preinstallation)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Code Migration Model: Moving computations to data (ship code to client) reduces communication cost; two drivers are performance (reduce remote calls) and flexibility (dynamic client configuration without preinstallation)
