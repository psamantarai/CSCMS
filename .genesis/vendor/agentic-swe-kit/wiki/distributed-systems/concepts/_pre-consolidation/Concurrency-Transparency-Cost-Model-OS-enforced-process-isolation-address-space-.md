---
title: Concurrency Transparency Cost Model: OS-enforced process isolation (address space creation, MMU updates, TLB invalidation, potential disk swap) is the price of concurrency transparency; threads forego this transparency to avoid that cost
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Concurrency Transparency Cost Model: OS-enforced process isolation (address space creation, MMU updates, TLB invalidation, potential disk swap) is the price of concurrency transparency; threads forego this transparency to avoid that cost
