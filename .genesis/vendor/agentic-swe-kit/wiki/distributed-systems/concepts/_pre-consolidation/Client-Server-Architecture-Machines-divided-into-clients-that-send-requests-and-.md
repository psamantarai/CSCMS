---
title: Client-Server Architecture: Machines divided into clients that send requests and servers that process and return results, reflecting traditional modular software decomposition placed on different physical machines
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Client-Server Architecture: Machines divided into clients that send requests and servers that process and return results, reflecting traditional modular software decomposition placed on different physical machines
