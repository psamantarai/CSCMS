---
title: Remote Procedure Call (RPC): A communication abstraction that hides message-passing complexity by making remote service calls appear as local procedure calls via client-side stubs that marshal parameters and unmarshal results
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Remote Procedure Call (RPC): A communication abstraction that hides message-passing complexity by making remote service calls appear as local procedure calls via client-side stubs that marshal parameters and unmarshal results
