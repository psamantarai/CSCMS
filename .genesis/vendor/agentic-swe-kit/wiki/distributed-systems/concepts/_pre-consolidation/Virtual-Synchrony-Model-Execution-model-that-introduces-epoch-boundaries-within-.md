---
title: Virtual Synchrony Model: Execution model that introduces epoch boundaries within which group membership is stable and messages are reliably delivered; no message can cross a boundary
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Virtual Synchrony Model: Execution model that introduces epoch boundaries within which group membership is stable and messages are reliably delivered; no message can cross a boundary
