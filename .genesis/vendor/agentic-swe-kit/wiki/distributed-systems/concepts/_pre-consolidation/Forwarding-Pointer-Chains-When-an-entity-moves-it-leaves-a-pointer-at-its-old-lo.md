---
title: Forwarding Pointer Chains: When an entity moves, it leaves a pointer at its old location; resolution traverses the chain; chains must be periodically shortened to avoid degradation
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Forwarding Pointer Chains: When an entity moves, it leaves a pointer at its old location; resolution traverses the chain; chains must be periodically shortened to avoid degradation
