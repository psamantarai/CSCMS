---
title: Primary-Based Protocols: all update operations are forwarded to a primary copy that orders and propagates them, simplifying ordering at the cost of a single coordination point
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Primary-Based Protocols: all update operations are forwarded to a primary copy that orders and propagates them, simplifying ordering at the cost of a single coordination point
