---
title: Lamport Logical Clocks: Each event e is assigned a globally unique logical timestamp C(e) such that if event a happened before b, then C(a) < C(b), enabling global ordering without wall-clock agreement
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Lamport Logical Clocks: Each event e is assigned a globally unique logical timestamp C(e) such that if event a happened before b, then C(a) < C(b), enabling global ordering without wall-clock agreement
