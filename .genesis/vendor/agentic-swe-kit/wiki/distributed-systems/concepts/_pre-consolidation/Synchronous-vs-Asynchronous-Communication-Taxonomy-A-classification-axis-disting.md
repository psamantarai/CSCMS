---
title: Synchronous vs. Asynchronous Communication Taxonomy: A classification axis distinguishing whether the sender blocks until receipt/delivery/response (synchronous) or continues immediately after submission (asynchronous)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Synchronous vs. Asynchronous Communication Taxonomy: A classification axis distinguishing whether the sender blocks until receipt/delivery/response (synchronous) or continues immediately after submission (asynchronous)
