...
book_slug: distributed-systems
phase: 2
created: 2026-05-12
---

# Wiki Schema — Distributed Systems

## Domain
Engineering knowledge extracted from Phase 2 study: Distributed Systems.
...
- Raw source: `output/extracts/distributed-systems/` — immutable, never modify

## Tag Taxonomy
- phase-2: all pages in this wiki
- distributed-systems: all pages in this wiki
