---
title: Security Usability Principle (Whitten-Tygar): Security mechanisms fail when the cognitive burden of correct use exceeds the user's mental model of the system, as demonstrated by the 'Why Johnny Can't Encrypt' result
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Security Usability Principle (Whitten-Tygar): Security mechanisms fail when the cognitive burden of correct use exceeds the user's mental model of the system, as demonstrated by the 'Why Johnny Can't Encrypt' result
