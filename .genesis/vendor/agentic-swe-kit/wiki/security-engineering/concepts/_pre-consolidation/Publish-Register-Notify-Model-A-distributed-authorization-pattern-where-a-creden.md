---
title: Publish-Register-Notify Model: A distributed authorization pattern where a credential issuer publishes state, relying parties register interest, and the issuer notifies them of changes — used to handle pre-authorization and revocation robustly
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Publish-Register-Notify Model: A distributed authorization pattern where a credential issuer publishes state, relying parties register interest, and the issuer notifies them of changes — used to handle pre-authorization and revocation robustly
