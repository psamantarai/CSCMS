---
title: Shared Control Scheme: requiring multiple independent parties to simultaneously authorize a critical action, so no single actor can unilaterally trigger it
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Shared Control Scheme: requiring multiple independent parties to simultaneously authorize a critical action, so no single actor can unilaterally trigger it
