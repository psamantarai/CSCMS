---
title: Mandatory Access Control (MAC): system-enforced access rules that cannot be overridden by users, as opposed to discretionary access control where owners set permissions; now embedded in Android, iOS, and Windows to protect core OS components from malware
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Mandatory Access Control (MAC): system-enforced access rules that cannot be overridden by users, as opposed to discretionary access control where owners set permissions; now embedded in Android, iOS, and Windows to protect core OS components from malware
