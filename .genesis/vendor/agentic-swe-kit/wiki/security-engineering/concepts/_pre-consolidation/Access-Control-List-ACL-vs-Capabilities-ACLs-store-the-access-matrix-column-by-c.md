---
title: Access Control List (ACL) vs Capabilities: ACLs store the access matrix column-by-column (per resource); capabilities store it row-by-row (per principal/ticket), each with distinct management and delegation trade-offs
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Access Control List (ACL) vs Capabilities: ACLs store the access matrix column-by-column (per resource); capabilities store it row-by-row (per principal/ticket), each with distinct management and delegation trade-offs
