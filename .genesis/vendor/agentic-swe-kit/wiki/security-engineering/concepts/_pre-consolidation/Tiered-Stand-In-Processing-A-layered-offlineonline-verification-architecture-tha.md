---
title: Tiered Stand-In Processing: A layered offline/online verification architecture that trades freshness of security state for availability and cost, used in payment card networks with floor limits and escalating verification levels
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Tiered Stand-In Processing: A layered offline/online verification architecture that trades freshness of security state for availability and cost, used in payment card networks with floor limits and escalating verification levels
