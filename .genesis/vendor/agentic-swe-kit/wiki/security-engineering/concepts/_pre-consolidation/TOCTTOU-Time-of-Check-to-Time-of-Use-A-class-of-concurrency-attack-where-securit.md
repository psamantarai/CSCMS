---
title: TOCTTOU (Time-of-Check-to-Time-of-Use): A class of concurrency attack where security state is validated at one moment but acted upon later, allowing an attacker to alter the state in between
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# TOCTTOU (Time-of-Check-to-Time-of-Use): A class of concurrency attack where security state is validated at one moment but acted upon later, allowing an attacker to alter the state in between
