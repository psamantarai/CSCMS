---
title: Shared Control / Dual-Custody Model: Splitting key material across multiple custodians or components so no single person or failure can compromise the whole secret; a mitigation against insider theft and single points of failure
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Shared Control / Dual-Custody Model: Splitting key material across multiple custodians or components so no single person or failure can compromise the whole secret; a mitigation against insider theft and single points of failure
