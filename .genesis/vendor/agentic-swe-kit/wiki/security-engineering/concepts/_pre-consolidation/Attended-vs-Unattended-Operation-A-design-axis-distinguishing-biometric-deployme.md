---
title: Attended vs. Unattended Operation: A design axis distinguishing biometric deployments where a human guard is present (higher security, complementary human-machine strengths) from fully automated ones (higher forgery risk)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-2, security-engineering, concept]
sources: [extracts/security-engineering/Biometrics.json]
contributing_chapters: ["Biometrics"]
confidence: high
---

# Attended vs. Unattended Operation: A design axis distinguishing biometric deployments where a human guard is present (higher security, complementary human-machine strengths) from fully automated ones (higher forgery risk)

> From chapter: *Biometrics*
