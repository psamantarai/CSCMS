---
title: Security Theatre Detection Model: Distinguishes visible-but-ineffective controls from effective-but-invisible ones; identifies when incentive misalignment causes theatrical over investment (e.g., TSA screening vs. cockpit door reinforcement)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Security Theatre Detection Model: Distinguishes visible-but-ineffective controls from effective-but-invisible ones; identifies when incentive misalignment causes theatrical over investment (e.g., TSA screening vs. cockpit door reinforcement)
