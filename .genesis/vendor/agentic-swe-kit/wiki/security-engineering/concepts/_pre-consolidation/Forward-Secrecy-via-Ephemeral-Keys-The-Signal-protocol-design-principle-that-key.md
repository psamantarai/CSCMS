---
title: Forward Secrecy via Ephemeral Keys: The Signal protocol design principle that key compromise today must not expose past communications, requiring per-session key material rather than long-lived private keys
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Forward Secrecy via Ephemeral Keys: The Signal protocol design principle that key compromise today must not expose past communications, requiring per-session key material rather than long-lived private keys
