---
title: Access Control Matrix: A two- or three-dimensional model mapping principals (users/programs) to resources (files/ports) with permission entries (read/write/execute), used to express and implement protection policy
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Access Control Matrix: A two- or three-dimensional model mapping principals (users/programs) to resources (files/ports) with permission entries (read/write/execute), used to express and implement protection policy
