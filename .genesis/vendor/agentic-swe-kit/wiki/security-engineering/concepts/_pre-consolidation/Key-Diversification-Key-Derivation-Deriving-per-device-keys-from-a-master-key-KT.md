---
title: Key Diversification / Key Derivation: Deriving per-device keys from a master key (KT = {T}KM) so compromise of one token cannot masquerade as others without compromising the central server
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Key Diversification / Key Derivation: Deriving per-device keys from a master key (KT = {T}KM) so compromise of one token cannot masquerade as others without compromising the central server
