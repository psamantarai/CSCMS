---
title: Safety-Security Entanglement Model: Safety and security are co-emergent properties that must be designed in from the start and cannot be added later, as accidents expose attack surfaces and attacks can cause safety failures
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Safety-Security Entanglement Model: Safety and security are co-emergent properties that must be designed in from the start and cannot be added later, as accidents expose attack surfaces and attacks can cause safety failures
