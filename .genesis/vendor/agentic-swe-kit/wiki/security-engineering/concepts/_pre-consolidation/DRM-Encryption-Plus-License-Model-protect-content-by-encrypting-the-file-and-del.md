---
title: DRM Encryption-Plus-License Model: protect content by encrypting the file and delivering the decryption key separately as a 'license' scoped to a specific user, with a rights-management language specifying permitted actions
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# DRM Encryption-Plus-License Model: protect content by encrypting the file and delivering the decryption key separately as a 'license' scoped to a specific user, with a rights-management language specifying permitted actions
