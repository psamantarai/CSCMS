---
title: Multilevel Security (MLS) / Information Flow Control (IFC): a mandatory access control policy where data labeled at a classification level can only be read by principals whose clearance meets or exceeds that level, and information may only flow upward (Unclassified → Confidential → Secret → Top Secret), never downward without explicit declassification
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Multilevel Security (MLS) / Information Flow Control (IFC): a mandatory access control policy where data labeled at a classification level can only be read by principals whose clearance meets or exceeds that level, and information may only flow upward (Unclassified → Confidential → Secret → Top Secret), never downward without explicit declassification
