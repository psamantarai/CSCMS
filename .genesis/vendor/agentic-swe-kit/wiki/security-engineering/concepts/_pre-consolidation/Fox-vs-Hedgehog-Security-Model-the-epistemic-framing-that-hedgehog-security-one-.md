---
title: Fox vs. Hedgehog Security Model: the epistemic framing that hedgehog security (one big policy applied zealously everywhere, like MLS) is brittle and leads to overdesign, while fox security (many targeted policies for many problems) is usually more appropriate in practice
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Fox vs. Hedgehog Security Model: the epistemic framing that hedgehog security (one big policy applied zealously everywhere, like MLS) is brittle and leads to overdesign, while fox security (many targeted policies for many problems) is usually more appropriate in practice
