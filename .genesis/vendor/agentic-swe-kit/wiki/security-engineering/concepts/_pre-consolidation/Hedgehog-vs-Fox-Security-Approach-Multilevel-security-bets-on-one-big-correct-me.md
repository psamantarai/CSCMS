---
title: Hedgehog vs. Fox Security Approach: Multilevel security bets on one big correct mechanism (hedgehog); multilateral security requires deep application understanding and adversarial thinking across many vectors (fox)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Hedgehog vs. Fox Security Approach: Multilevel security bets on one big correct mechanism (hedgehog); multilateral security requires deep application understanding and adversarial thinking across many vectors (fox)
