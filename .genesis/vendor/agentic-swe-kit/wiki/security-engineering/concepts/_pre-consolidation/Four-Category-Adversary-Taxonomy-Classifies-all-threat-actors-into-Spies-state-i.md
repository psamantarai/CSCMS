---
title: Four-Category Adversary Taxonomy: Classifies all threat actors into Spies (state intelligence), Crooks (financially motivated criminals), Hackers/Researchers (vulnerability finders, bug reporters), and Bullies (personal abuse, stalkers, harassers)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Four-Category Adversary Taxonomy: Classifies all threat actors into Spies (state intelligence), Crooks (financially motivated criminals), Hackers/Researchers (vulnerability finders, bug reporters), and Bullies (personal abuse, stalkers, harassers)
