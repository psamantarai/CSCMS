---
title: Multilateral Security (Lattice/Compartment Model): Controls information flow laterally across peer groups rather than just vertically down a hierarchy, using incompatible security labels to isolate compartments
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Multilateral Security (Lattice/Compartment Model): Controls information flow laterally across peer groups rather than just vertically down a hierarchy, using incompatible security labels to isolate compartments
