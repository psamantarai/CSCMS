---
title: Layered Cryptographic Platforms: Using cryptographic components (HSMs, enclaves, blockchains) as trust anchors on which higher-level systems are built, with each layer adding complexity and new attack surfaces
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Layered Cryptographic Platforms: Using cryptographic components (HSMs, enclaves, blockchains) as trust anchors on which higher-level systems are built, with each layer adding complexity and new attack surfaces
