---
title: Crime Prevention Through Environmental Design (CPTED): A criminology/architecture framework asserting that environmental design (visibility, territoriality, lighting, layout) directly reduces crime incidence, with analogues in system design
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Crime Prevention Through Environmental Design (CPTED): A criminology/architecture framework asserting that environmental design (visibility, territoriality, lighting, layout) directly reduces crime incidence, with analogues in system design
