---
title: Double-Entry Bookkeeping: Every transaction is posted to two separate books as a credit in one and a debit in the other, so the system always sums to zero and any discrepancy triggers an alarm
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-2, security-engineering, concept]
sources: [extracts/security-engineering/Banking-and-Bookkeeping.json]
contributing_chapters: ["Banking and Bookkeeping"]
confidence: high
---

# Double-Entry Bookkeeping: Every transaction is posted to two separate books as a credit in one and a debit in the other, so the system always sums to zero and any discrepancy triggers an alarm

> From chapter: *Banking and Bookkeeping*
