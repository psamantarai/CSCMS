---
title: Statistical Balancing for Loss Detection: Compare feeder meter readings against sum of sub-meter readings to detect non-technical losses (theft/tampering) without requiring per-event forensics
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-2, security-engineering, concept]
sources: [extracts/security-engineering/Monitoring-and-Metering.json]
contributing_chapters: ["Monitoring and Metering"]
confidence: high
---

# Statistical Balancing for Loss Detection: Compare feeder meter readings against sum of sub-meter readings to detect non-technical losses (theft/tampering) without requiring per-event forensics

> From chapter: *Monitoring and Metering*
