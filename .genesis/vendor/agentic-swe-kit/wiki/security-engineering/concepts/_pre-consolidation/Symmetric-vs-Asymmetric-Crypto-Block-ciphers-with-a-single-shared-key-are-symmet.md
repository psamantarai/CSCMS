---
title: Symmetric vs Asymmetric Crypto: Block ciphers with a single shared key are symmetric; those with separate encryption/decryption keys are asymmetric (public-key), with digital signatures as a special asymmetric primitive
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Symmetric vs Asymmetric Crypto: Block ciphers with a single shared key are symmetric; those with separate encryption/decryption keys are asymmetric (public-key), with digital signatures as a special asymmetric primitive
