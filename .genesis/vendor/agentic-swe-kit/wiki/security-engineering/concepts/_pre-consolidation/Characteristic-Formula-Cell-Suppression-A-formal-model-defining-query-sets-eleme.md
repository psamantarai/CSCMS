---
title: Characteristic Formula / Cell Suppression: A formal model defining query sets, elementary cells, sensitive statistics, and suppression rules to prevent disclosure, with the goal D ⊆ P′ (disclosed statistics must not overlap protected statistics)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Characteristic Formula / Cell Suppression: A formal model defining query sets, elementary cells, sensitive statistics, and suppression rules to prevent disclosure, with the goal D ⊆ P′ (disclosed statistics must not overlap protected statistics)
