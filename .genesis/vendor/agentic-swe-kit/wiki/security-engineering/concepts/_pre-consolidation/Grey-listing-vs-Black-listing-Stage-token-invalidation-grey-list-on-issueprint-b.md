---
title: Grey-listing vs Black-listing: Stage token invalidation — grey-list on issue/print, black-list only on confirmed use — to avoid penalizing users for system failures (e.g., printer jams)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Grey-listing vs Black-listing: Stage token invalidation — grey-list on issue/print, black-list only on confirmed use — to avoid penalizing users for system failures (e.g., printer jams)
