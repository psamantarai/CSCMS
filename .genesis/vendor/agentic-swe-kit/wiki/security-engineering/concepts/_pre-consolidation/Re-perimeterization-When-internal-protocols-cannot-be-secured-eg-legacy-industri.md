---
title: Re-perimeterization: When internal protocols cannot be secured (e.g., legacy industrial control systems), concentrate all protection at the single external connection point rather than attempting to retrofit crypto internally
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Re-perimeterization: When internal protocols cannot be secured (e.g., legacy industrial control systems), concentrate all protection at the single external connection point rather than attempting to retrofit crypto internally
