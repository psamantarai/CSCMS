---
title: FIPS 140 Evaluation Levels: A tiered framework (levels 1–4) for rating tamper resistance of cryptographic modules, from software-only to physically hardened devices that resist all known physical attacks
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# FIPS 140 Evaluation Levels: A tiered framework (levels 1–4) for rating tamper resistance of cryptographic modules, from software-only to physically hardened devices that resist all known physical attacks
