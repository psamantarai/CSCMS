---
title: Perfect Secrecy (Shannon): A cipher has perfect secrecy if and only if there are as many possible keys as possible plaintexts and every key is equally likely; the one-time pad is the only system achieving this
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Perfect Secrecy (Shannon): A cipher has perfect secrecy if and only if there are as many possible keys as possible plaintexts and every key is equally likely; the one-time pad is the only system achieving this
