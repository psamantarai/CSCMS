---
title: Soviet One-Third Doctrine: Destroy one third physically, deny effective use of a second third via jamming/trojans/deception, then let the adversary disable the remaining third by overloading it — a combined-arms denial-of-service model
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Soviet One-Third Doctrine: Destroy one third physically, deny effective use of a second third via jamming/trojans/deception, then let the adversary disable the remaining third by overloading it — a combined-arms denial-of-service model
