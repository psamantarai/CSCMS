---
title: Threat Model Evaluation: Two-question framework — (1) Is the threat model realistic? (2) Does the protocol deal with it? — applied before accepting any protocol design
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Threat Model Evaluation: Two-question framework — (1) Is the threat model realistic? (2) Does the protocol deal with it? — applied before accepting any protocol design
