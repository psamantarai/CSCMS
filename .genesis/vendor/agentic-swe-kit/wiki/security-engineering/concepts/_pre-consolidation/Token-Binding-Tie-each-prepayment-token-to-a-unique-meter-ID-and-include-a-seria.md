---
title: Token Binding: Tie each prepayment token to a unique meter ID and include a serial/random nonce so the same token cannot work in a different meter or be replayed in the same meter twice
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Token Binding: Tie each prepayment token to a unique meter ID and include a serial/random nonce so the same token cannot work in a different meter or be replayed in the same meter twice
