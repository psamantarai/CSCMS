...
## Certificate Transparency A publicly auditable log of all certificates issued per
...
## Deperimeterization The architectural trend away from firewall protected intranet
...
## Power Law Network Vulnerability Model Social and infrastructure networks with po
...
## Re perimeterization When internal protocols cannot be secured eg legacy industri
...
## Zero Trust BeyondCorp Eliminate the trusted internal network concept shift acces
