...
## Concrete Security Indistinguishability Random Oracle Model Formal security model
...
## Modes of Operation Block ciphers are composed into stream ciphers and hash funct
...
## Perfect Secrecy Shannon A cipher has perfect secrecy if and only if there are as
...
## Stream Cipher vs Block Cipher Stream ciphers make the encryption rule depend on
...
## Symmetric vs Asymmetric Crypto Block ciphers with a single shared key are symmet
...
## Three Levels of Crypto Understanding 1 underlying intuitions 2 mathematics for s
