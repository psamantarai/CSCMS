...
book_slug: security-engineering
phase: 2
created: 2026-05-12
---

# Wiki Schema — Security Engineering

## Domain
Engineering knowledge extracted from Phase 2 study: Security Engineering.
...
- Raw source: `output/extracts/security-engineering/` — immutable, never modify

## Tag Taxonomy
- phase-2: all pages in this wiki
- security-engineering: all pages in this wiki
