...
book_slug: release-it
phase: 1
created: 2026-05-12
---

# Wiki Schema — Production-Ready Systems

## Domain
Engineering knowledge extracted from Phase 1 study: Production-Ready Systems.
...
- Raw source: `output/extracts/release-it/` — immutable, never modify

## Tag Taxonomy
- phase-1: all pages in this wiki
- release-it: all pages in this wiki
