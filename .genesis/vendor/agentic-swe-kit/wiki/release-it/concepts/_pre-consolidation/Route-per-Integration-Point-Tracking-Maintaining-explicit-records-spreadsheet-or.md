---
title: Route-per-Integration-Point Tracking: Maintaining explicit records (spreadsheet or database) of destination name, address, and desired route for every remote integration point
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Route-per-Integration-Point Tracking: Maintaining explicit records (spreadsheet or database) of destination name, address, and desired route for every remote integration point
