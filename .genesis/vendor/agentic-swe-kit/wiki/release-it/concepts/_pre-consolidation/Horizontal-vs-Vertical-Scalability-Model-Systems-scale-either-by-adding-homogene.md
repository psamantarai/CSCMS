---
title: Horizontal vs. Vertical Scalability Model: Systems scale either by adding homogeneous servers behind a load balancer (horizontal/shared-nothing) or by upgrading existing servers (vertical), with different cost and ceiling implications
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, release-it, concept]
sources: [extracts/release-it/Chapter-8-Introducing-Capacity.json]
contributing_chapters: ["Chapter 8: Introducing Capacity"]
confidence: high
---

# Horizontal vs. Vertical Scalability Model: Systems scale either by adding homogeneous servers behind a load balancer (horizontal/shared-nothing) or by upgrading existing servers (vertical), with different cost and ceiling implications

> From chapter: *Chapter 8: Introducing Capacity*
