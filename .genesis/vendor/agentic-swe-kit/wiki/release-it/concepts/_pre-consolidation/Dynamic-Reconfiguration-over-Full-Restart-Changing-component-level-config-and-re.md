---
title: Dynamic Reconfiguration over Full Restart: Changing component-level config and restarting only that component (stopService/startService) is far faster than restarting entire servers under load
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Dynamic Reconfiguration over Full Restart: Changing component-level config and restarting only that component (stopService/startService) is far faster than restarting entire servers under load
