---
title: Driving/Following Variables Model: Capacity is analyzed by identifying external driving variables (e.g., requests/second) and the internal following variables (CPU, RAM, I/O) that respond to them, tracing causal chains across layers
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Driving/Following Variables Model: Capacity is analyzed by identifying external driving variables (e.g., requests/second) and the internal following variables (CPU, RAM, I/O) that respond to them, tracing causal chains across layers
