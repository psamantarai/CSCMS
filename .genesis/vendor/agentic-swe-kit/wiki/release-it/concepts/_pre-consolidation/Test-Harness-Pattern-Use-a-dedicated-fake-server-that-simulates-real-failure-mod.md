---
title: Test Harness Pattern: Use a dedicated fake server that simulates real failure modes (slow responses, dropped connections, garbage data) to test non-functional resilience behavior in isolation
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, release-it, concept]
sources: [extracts/release-it/Chapter-5-Stability-Patterns.json]
contributing_chapters: ["Chapter 5: Stability Patterns"]
confidence: high
---

# Test Harness Pattern: Use a dedicated fake server that simulates real failure modes (slow responses, dropped connections, garbage data) to test non-functional resilience behavior in isolation

> From chapter: *Chapter 5: Stability Patterns*
