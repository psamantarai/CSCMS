---
title: Highly Interactive Complexity: A system condition where enough moving parts and hidden internal dependencies exist that operators' mental models are incomplete or wrong, causing well-intentioned actions to trigger unexpected harmful linkages
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Highly Interactive Complexity: A system condition where enough moving parts and hidden internal dependencies exist that operators' mental models are incomplete or wrong, causing well-intentioned actions to trigger unexpected harmful linkages
