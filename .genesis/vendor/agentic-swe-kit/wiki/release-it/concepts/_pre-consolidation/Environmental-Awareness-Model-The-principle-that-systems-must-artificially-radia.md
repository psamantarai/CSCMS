---
title: Environmental Awareness Model: The principle that systems must artificially radiate information (like a ship's diesel engine does naturally) because software runs in faceless boxes with no ambient signals — transparency must be deliberately built in
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Environmental Awareness Model: The principle that systems must artificially radiate information (like a ship's diesel engine does naturally) because software runs in faceless boxes with no ambient signals — transparency must be deliberately built in
