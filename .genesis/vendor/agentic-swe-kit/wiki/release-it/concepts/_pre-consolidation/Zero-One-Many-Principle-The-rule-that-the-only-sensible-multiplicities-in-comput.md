---
title: Zero-One-Many Principle: The rule that the only sensible multiplicities in computer science are 0, 1, and many — meaning QA must run more than one instance wherever production runs a cluster, not just one
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Zero-One-Many Principle: The rule that the only sensible multiplicities in computer science are 0, 1, and many — meaning QA must run more than one instance wherever production runs a cluster, not just one
