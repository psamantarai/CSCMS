---
title: Session Bloat Anti-Pattern: Placing large objects (full shopping carts, full search results) in serialized sessions, which destroys session-failover scalability and forces disabling of the failover mechanism entirely
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Session Bloat Anti-Pattern: Placing large objects (full shopping carts, full search results) in serialized sessions, which destroys session-failover scalability and forces disabling of the failover mechanism entirely
