---
title: Connection Pool Management: Three strategies for managing database connections in web systems — per-page (one connection per full page request), per-fragment (each fragment manages its own connection), and hybrid (fragment-level connections bound to a page-level transaction)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Connection Pool Management: Three strategies for managing database connections in web systems — per-page (one connection per full page request), per-fragment (each fragment manages its own connection), and hybrid (fragment-level connections bound to a page-level transaction)
