---
title: Per-Application User Isolation: Each major application runs under its own OS user account so that a compromise of one application cannot directly access another's resources
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Per-Application User Isolation: Each major application runs under its own OS user account so that a compromise of one application cannot directly access another's resources
