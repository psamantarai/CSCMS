---
title: Theory of Constraints (Goldratt): A management framework identifying that system throughput is limited by a single bottleneck that must be found and exploited before optimizing elsewhere
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Theory of Constraints (Goldratt): A management framework identifying that system throughput is limited by a single bottleneck that must be found and exploited before optimizing elsewhere
