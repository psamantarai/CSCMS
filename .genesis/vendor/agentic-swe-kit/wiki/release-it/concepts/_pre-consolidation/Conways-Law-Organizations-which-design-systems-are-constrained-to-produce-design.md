---
title: Conway's Law: Organizations which design systems are constrained to produce designs whose structure are copies of the communication structures of those organizations — used both prescriptively (shape comms to shape software) and descriptively (map software to understand real org structure)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Conway's Law: Organizations which design systems are constrained to produce designs whose structure are copies of the communication structures of those organizations — used both prescriptively (shape comms to shape software) and descriptively (map software to understand real org structure)
