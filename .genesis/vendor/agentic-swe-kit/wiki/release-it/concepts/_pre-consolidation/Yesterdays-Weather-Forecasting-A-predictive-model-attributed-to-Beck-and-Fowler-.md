---
title: Yesterday's Weather Forecasting: A predictive model (attributed to Beck and Fowler) where tomorrow's system behavior is predicted by extrapolating past measurements, valid within a defined domain of applicability and invalidated by each new application release
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Yesterday's Weather Forecasting: A predictive model (attributed to Beck and Fowler) where tomorrow's system behavior is predicted by extrapolating past measurements, valid within a defined domain of applicability and invalidated by each new application release
