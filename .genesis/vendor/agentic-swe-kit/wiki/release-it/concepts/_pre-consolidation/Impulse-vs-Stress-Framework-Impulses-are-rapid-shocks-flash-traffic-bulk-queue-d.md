---
title: Impulse vs. Stress Framework: Impulses are rapid shocks (flash traffic, bulk queue dumps) while stresses are sustained forces (slow upstream dependency); each requires different defensive design
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Impulse vs. Stress Framework: Impulses are rapid shocks (flash traffic, bulk queue dumps) while stresses are sustained forces (slow upstream dependency); each requires different defensive design
