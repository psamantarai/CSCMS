---
title: Automated Data Collection for Post-Mortem: A pattern of pre-scripted, non-intrusive data capture (thread dumps, DB snapshots) that enables root cause analysis without prolonging the outage
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Automated Data Collection for Post-Mortem: A pattern of pre-scripted, non-intrusive data capture (thread dumps, DB snapshots) that enables root cause analysis without prolonging the outage
