...
## Password Vaulting Storing credentials in encrypted files to reduce the security
...
## Per Application User Isolation Each major application runs under its own OS user
...
## Principle of Least Privilege A process should have the lowest level of privilege
...
## Privilege Separation A technique where a process deliberately downgrades its own
