---
domain: Engineering Mindset and Code Quality
book_slug: pragmatic-programmer
phase: 1
created: 2026-05-11
---

# Wiki Schema — Engineering Mindset and Code Quality

## Domain
Engineering knowledge extracted from Phase 1 study: Engineering Mindset and Code Quality.
...
- Raw source: `output/extracts/pragmatic-programmer/` — immutable, never modify

## Tag Taxonomy
- phase-1: all pages in this wiki
- pragmatic-programmer: all pages in this wiki
