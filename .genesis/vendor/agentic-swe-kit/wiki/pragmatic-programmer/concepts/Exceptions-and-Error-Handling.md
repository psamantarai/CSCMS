...
## Error Handler Registration Pattern An alternative to exceptions where a routine
...
## Exceptional vs Expected Error Errors are classified by whether the program had a
...
## Remove All Handlers Test A heuristic model for validating exception use if remov
