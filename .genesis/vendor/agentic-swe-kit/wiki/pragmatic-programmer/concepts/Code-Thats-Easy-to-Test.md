...
## Bottom Up Subcomponent Verification Test subcomponents eg LinkedList Sort fully
...
## Built In Self Test BIST Test Access Mechanism TAM Hardware inspired pattern wher
...
## Software IC Integrated Circuit A metaphor where software components are treated
...
## Test Harness A standardized infrastructure providing setupcleanup test selection
...
## Testing Against Contract Unit tests are written directly against a modules forma
