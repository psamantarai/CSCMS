...
## Blackboard Pattern A shared decoupled data store where independent agents readwr
...
## Rules Engine Blackboard Combination Pairing a blackboard with a rules engine so
...
## Tuple Space Linda Model A keyvalue or object store eg JavaSpaces T Spaces suppor
