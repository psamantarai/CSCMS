...
## Dead Reckoning Anti model The failed alternative where you specify everything up
...
## Tracer Bullet Development Build a thin end to end slice of the real system early
...
## Tracer vs Prototype Distinction Tracer code is lean but production quality and k
