---
title: Big O Notation: A mathematical approximation that expresses the upper bound on how an algorithm's resource usage (time, memory) scales with input size n, retaining only the dominant term
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Big O Notation: A mathematical approximation that expresses the upper bound on how an algorithm's resource usage (time, memory) scales with input size n, retaining only the dominant term
