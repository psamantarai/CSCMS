---
title: Content-Driven Workflow: Automation triggers should be driven by the content of source code and documents (e.g., status markers), not by human memory or manual scheduling
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Content-Driven Workflow: Automation triggers should be driven by the content of source code and documents (e.g., status markers), not by human memory or manual scheduling
