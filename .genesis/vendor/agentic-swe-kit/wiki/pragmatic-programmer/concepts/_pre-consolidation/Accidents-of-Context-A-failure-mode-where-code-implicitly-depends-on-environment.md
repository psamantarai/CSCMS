---
title: Accidents of Context: A failure mode where code implicitly depends on environmental assumptions (GUI present, English users, specific OS) that are not guaranteed
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Accidents of Context: A failure mode where code implicitly depends on environmental assumptions (GUI present, English users, specific OS) that are not guaranteed
