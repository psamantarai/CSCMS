---
title: Metadata-Driven Applications: Architecting a general-purpose engine whose specific behavior is entirely determined by external metadata, enabling reuse across projects by swapping configuration
created: 2026-05-11
updated: 2026-05-11
type: concept
tags: [phase-1, pragmatic-programmer, concept]
sources: [extracts/pragmatic-programmer/27-Metaprogramming.json]
contributing_chapters: ["27. Metaprogramming"]
confidence: high
---

# Metadata-Driven Applications: Architecting a general-purpose engine whose specific behavior is entirely determined by external metadata, enabling reuse across projects by swapping configuration

> From chapter: *27. Metaprogramming*
