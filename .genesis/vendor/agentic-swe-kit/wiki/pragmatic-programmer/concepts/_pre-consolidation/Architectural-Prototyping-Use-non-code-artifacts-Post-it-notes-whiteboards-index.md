---
title: Architectural Prototyping: Use non-code artifacts (Post-it notes, whiteboards, index cards) to validate how a system hangs together—component responsibilities, coupling, data access paths—before writing any real code
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Architectural Prototyping: Use non-code artifacts (Post-it notes, whiteboards, index cards) to validate how a system hangs together—component responsibilities, coupling, data access paths—before writing any real code
