---
title: Self-Describing Data Stream: storing data in plain text with meaningful labels so the data carries its own context and meaning independent of the application that created it
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Self-Describing Data Stream: storing data in plain text with meaningful labels so the data carries its own context and meaning independent of the application that created it
