---
title: Functional Team Organization: Divide teams by functional area (not job role) mirroring code modularity principles—contracts, decoupling, orthogonality—so changes affect only the relevant sub-team
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Functional Team Organization: Divide teams by functional area (not job role) mirroring code modularity principles—contracts, decoupling, orthogonality—so changes affect only the relevant sub-team
