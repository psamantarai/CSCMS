---
title: Unix Philosophy: small, sharp tools each doing one thing well, enabled by a common underlying plain text format so all tools interoperate
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Unix Philosophy: small, sharp tools each doing one thing well, enabled by a common underlying plain text format so all tools interoperate
