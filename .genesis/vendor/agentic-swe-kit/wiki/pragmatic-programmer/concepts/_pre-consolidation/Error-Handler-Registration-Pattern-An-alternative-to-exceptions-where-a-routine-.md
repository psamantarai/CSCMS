---
title: Error Handler Registration Pattern: An alternative to exceptions where a routine is registered to handle a specific category of errors, decoupling error detection from handling logic
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Error Handler Registration Pattern: An alternative to exceptions where a routine is registered to handle a specific category of errors, decoupling error detection from handling logic
