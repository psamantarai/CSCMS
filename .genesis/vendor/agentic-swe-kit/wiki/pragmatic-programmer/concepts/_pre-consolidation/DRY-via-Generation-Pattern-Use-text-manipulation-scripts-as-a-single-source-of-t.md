---
title: DRY-via-Generation Pattern: Use text manipulation scripts as a single source of truth to generate multiple artifacts (SQL, C code, docs, XML) from one canonical definition, avoiding duplication
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# DRY-via-Generation Pattern: Use text manipulation scripts as a single source of truth to generate multiple artifacts (SQL, C code, docs, XML) from one canonical definition, avoiding duplication
