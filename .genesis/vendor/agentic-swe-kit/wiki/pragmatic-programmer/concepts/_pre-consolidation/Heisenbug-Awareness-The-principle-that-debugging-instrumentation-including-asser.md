---
title: Heisenbug Awareness: The principle that debugging instrumentation (including assertions) must not alter program behavior, particularly by introducing side effects in condition expressions
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Heisenbug Awareness: The principle that debugging instrumentation (including assertions) must not alter program behavior, particularly by introducing side effects in condition expressions
