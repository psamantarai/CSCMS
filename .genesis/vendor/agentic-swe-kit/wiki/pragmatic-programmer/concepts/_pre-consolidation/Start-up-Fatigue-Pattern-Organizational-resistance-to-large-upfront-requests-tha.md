---
title: Start-up Fatigue Pattern: Organizational resistance to large upfront requests that dissolves when presented with an existing, working prototype
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Start-up Fatigue Pattern: Organizational resistance to large upfront requests that dissolves when presented with an existing, working prototype
