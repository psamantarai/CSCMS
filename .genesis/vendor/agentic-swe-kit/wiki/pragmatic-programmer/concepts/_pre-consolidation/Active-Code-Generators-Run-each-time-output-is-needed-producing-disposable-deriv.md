---
title: Active Code Generators: Run each time output is needed, producing disposable derived artifacts from a single authoritative source, enforcing DRY across disparate environments
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Active Code Generators: Run each time output is needed, producing disposable derived artifacts from a single authoritative source, enforcing DRY across disparate environments
