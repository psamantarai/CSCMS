---
title: Stand-Alone vs. Embedded Language Pattern: Mini-languages can operate as standalone specification tools that generate artifacts, or be embedded directly in the application to change behavior without recompilation
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Stand-Alone vs. Embedded Language Pattern: Mini-languages can operate as standalone specification tools that generate artifacts, or be embedded directly in the application to change behavior without recompilation
