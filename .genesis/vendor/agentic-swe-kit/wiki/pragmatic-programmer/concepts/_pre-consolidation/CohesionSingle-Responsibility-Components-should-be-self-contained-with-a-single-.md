---
title: Cohesion/Single Responsibility: Components should be self-contained with a single, well-defined purpose so they can be designed, coded, tested, and then forgotten
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Cohesion/Single Responsibility: Components should be self-contained with a single, well-defined purpose so they can be designed, coded, tested, and then forgotten
