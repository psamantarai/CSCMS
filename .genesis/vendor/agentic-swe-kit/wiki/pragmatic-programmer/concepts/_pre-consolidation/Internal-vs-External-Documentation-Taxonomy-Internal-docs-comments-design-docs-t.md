---
title: Internal vs External Documentation Taxonomy: Internal docs (comments, design docs, test docs) live close to code; external docs (user manuals) are published — but both mirror the code model
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Internal vs External Documentation Taxonomy: Internal docs (comments, design docs, test docs) live close to code; external docs (user manuals) are published — but both mirror the code model
