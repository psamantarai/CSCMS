---
title: Requirements vs. Policy Separation: Requirements express invariant needs ('authorized users may access records'); policy is the current business rule that satisfies that need ('only supervisors and HR'). Policy belongs in metadata, not code
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Requirements vs. Policy Separation: Requirements express invariant needs ('authorized users may access records'); policy is the current business rule that satisfies that need ('only supervisors and HR'). Policy belongs in metadata, not code
