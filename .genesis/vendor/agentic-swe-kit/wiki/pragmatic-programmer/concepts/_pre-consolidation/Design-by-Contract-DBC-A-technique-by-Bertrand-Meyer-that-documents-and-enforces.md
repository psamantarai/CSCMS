---
title: Design by Contract (DBC): A technique by Bertrand Meyer that documents and enforces the rights and responsibilities of software modules via preconditions, postconditions, and class invariants to ensure program correctness
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Design by Contract (DBC): A technique by Bertrand Meyer that documents and enforces the rights and responsibilities of software modules via preconditions, postconditions, and class invariants to ensure program correctness
