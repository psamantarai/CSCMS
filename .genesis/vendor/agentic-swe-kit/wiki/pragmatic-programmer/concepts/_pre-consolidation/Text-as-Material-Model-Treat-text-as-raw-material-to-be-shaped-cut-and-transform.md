---
title: Text-as-Material Model: Treat text as raw material to be shaped, cut, and transformed using specialized scripting tools the same way a woodworker shapes wood with power tools
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Text-as-Material Model: Treat text as raw material to be shaped, cut, and transformed using specialized scripting tools the same way a woodworker shapes wood with power tools
