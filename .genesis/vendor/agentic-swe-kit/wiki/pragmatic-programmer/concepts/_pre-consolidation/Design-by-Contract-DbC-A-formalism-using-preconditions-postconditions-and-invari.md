---
title: Design by Contract (DbC): A formalism using preconditions, postconditions, and invariants to specify and enforce software correctness, originating from ISE Eiffel and implementable in Java via iContract
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Design by Contract (DbC): A formalism using preconditions, postconditions, and invariants to specify and enforce software correctness, originating from ISE Eiffel and implementable in Java via iContract
