---
title: Liskov Substitution Principle: Subclasses must be usable through the base class interface without the caller needing to know the difference, enforced via inherited contracts
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Liskov Substitution Principle: Subclasses must be usable through the base class interface without the caller needing to know the difference, enforced via inherited contracts
