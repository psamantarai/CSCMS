---
title: Executable Documents: A single authoritative source document generates multiple output artifacts (schema, code records, API docs) via tooling, preventing drift
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Executable Documents: A single authoritative source document generates multiple output artifacts (schema, code records, API docs) via tooling, preventing drift
