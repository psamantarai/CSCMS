---
title: Editor Feature Hierarchy: the minimum viable editor must be Configurable, Extensible, and Programmable — all other features (syntax highlighting, auto-complete, IDE integration) are additive
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Editor Feature Hierarchy: the minimum viable editor must be Configurable, Extensible, and Programmable — all other features (syntax highlighting, auto-complete, IDE integration) are additive
