---
title: UML Activity Diagram Workflow Analysis: a notation for capturing which workflow steps can run concurrently vs. must be strictly ordered, used to maximize parallelism
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# UML Activity Diagram Workflow Analysis: a notation for capturing which workflow steps can run concurrently vs. must be strictly ordered, used to maximize parallelism
