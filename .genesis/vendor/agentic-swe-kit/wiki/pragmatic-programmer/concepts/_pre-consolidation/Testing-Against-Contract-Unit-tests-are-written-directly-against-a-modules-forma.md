---
title: Testing Against Contract: Unit tests are written directly against a module's formal contract (preconditions, postconditions), verifying both that the code meets the contract and that the contract means what the developer thinks it means
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Testing Against Contract: Unit tests are written directly against a module's formal contract (preconditions, postconditions), verifying both that the code meets the contract and that the contract means what the developer thinks it means
