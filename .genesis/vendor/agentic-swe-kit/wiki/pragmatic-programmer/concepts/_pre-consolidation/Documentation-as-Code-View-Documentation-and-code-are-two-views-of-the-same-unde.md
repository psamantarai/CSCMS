---
title: Documentation-as-Code-View: Documentation and code are two views of the same underlying model — changing the model should update all views automatically
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Documentation-as-Code-View: Documentation and code are two views of the same underlying model — changing the model should update all views automatically
