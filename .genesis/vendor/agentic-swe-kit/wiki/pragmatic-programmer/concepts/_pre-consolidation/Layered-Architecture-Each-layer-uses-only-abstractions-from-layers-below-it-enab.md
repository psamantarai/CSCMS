---
title: Layered Architecture: Each layer uses only abstractions from layers below it, enabling implementation changes without cascading effects upward
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Layered Architecture: Each layer uses only abstractions from layers below it, enabling implementation changes without cascading effects upward
