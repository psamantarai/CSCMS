---
title: Law of Demeter for Functions: A method should only call methods belonging to itself, its parameters, objects it created, or its directly held component objects — never third-party objects retrieved through those objects
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Law of Demeter for Functions: A method should only call methods belonging to itself, its parameters, objects it created, or its directly held component objects — never third-party objects retrieved through those objects
