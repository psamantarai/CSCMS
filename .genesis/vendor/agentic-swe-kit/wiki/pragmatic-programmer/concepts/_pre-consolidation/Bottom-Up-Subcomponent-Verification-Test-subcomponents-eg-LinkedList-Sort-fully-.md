---
title: Bottom-Up Subcomponent Verification: Test subcomponents (e.g., LinkedList, Sort) fully before testing the module (A) that depends on them, so failures isolate to the integration layer
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Bottom-Up Subcomponent Verification: Test subcomponents (e.g., LinkedList, Sort) fully before testing the module (A) that depends on them, so failures isolate to the integration layer
