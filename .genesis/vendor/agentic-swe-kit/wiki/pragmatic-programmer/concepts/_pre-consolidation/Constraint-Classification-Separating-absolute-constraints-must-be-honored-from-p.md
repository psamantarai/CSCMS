---
title: Constraint Classification: Separating absolute constraints (must be honored) from preconceived notions (apparent constraints that are not real) to unlock solution space
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Constraint Classification: Separating absolute constraints (must be honored) from preconceived notions (apparent constraints that are not real) to unlock solution space
