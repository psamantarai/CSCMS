---
title: Empirical Curve Fitting: Running an algorithm with varying input sizes, plotting results, and inferring the complexity class from the shape of the resulting curve
created: 2026-05-11
updated: 2026-05-11
type: concept
...
# Empirical Curve Fitting: Running an algorithm with varying input sizes, plotting results, and inferring the complexity class from the shape of the resulting curve
