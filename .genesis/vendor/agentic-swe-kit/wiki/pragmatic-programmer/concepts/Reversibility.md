...
## Decisions in Sand Model treat every architectural and vendor decision as tempora
...
## Flexible Architecture Principle maintain reversibility not just in code but also
...
## Persistence as a Service Abstraction hide concrete third party products eg datab
...
## Schrödingers Code Evolution every decision forks the codebase into multiple poss
