...
## Common Understanding Model Both developer and user must converge on a shared ver
...
## Gently Exceed Expectations Success is measured not by specification correctness
...
## The Extra Mile Small low cost user facing features that signal care and intentio
