...
## Bug Reproduction Isolation reduce a bug to the minimal single command reproducti
...
## Fix the Problem Not the Blame redirect debugging energy from assigning fault to
...
## Process of Elimination Binary Search systematically bisect the codebase to local
...
## Rubber Ducking verbalize a problem step by step to an audience even inanimate to
...
## Surprise Calibration treat the magnitude of surprise at a bug as a signal that a
...
## Visualize Your Data inspect data structures and their relationships directly rat
