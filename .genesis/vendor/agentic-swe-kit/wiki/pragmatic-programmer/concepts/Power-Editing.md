...
## Editor Feature Hierarchy the minimum viable editor must be Configurable Extensib
...
## Editor as Extension of Hand mastering a single editor so deeply that text manipu
...
## Single Editor Principle choosing one configurable extensible programmable editor
