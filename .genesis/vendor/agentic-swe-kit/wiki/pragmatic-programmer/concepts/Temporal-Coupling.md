...
## Design for Concurrency Discipline the practice of always designing components as
...
## Hungry Consumer Model replacing a central scheduler with independent consumer ta
...
## Temporal Coupling the design problem of creating hidden time ordering dependenci
...
## UML Activity Diagram Workflow Analysis a notation for capturing which workflow s
