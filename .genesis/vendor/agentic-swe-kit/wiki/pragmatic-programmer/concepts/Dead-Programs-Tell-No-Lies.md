...
## Crash Early Principle Terminate a program immediately upon detecting an impossib
...
## Dead Program vs Crippled Program A cleanly terminated program causes far less da
...
## Defensive Coding Paranoia Treat every error returneven from calls that should ne
