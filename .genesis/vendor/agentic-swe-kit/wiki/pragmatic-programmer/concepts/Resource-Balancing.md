...
## Finish What You Start Tip 35 The routine or object that allocates a resource is
...
## Nested Allocation Order Deallocate resources in reverse order of allocation to p
...
## Resource Encapsulation in Classes Wrap resources in objects whose constructor ac
...
## Semantic Invariant for Aggregate Structures Explicitly decide and consistently i
