...
## Document Model: Data stored as self-contained JSON/XML documents, optimized for one-to-many tree-structured data and locality of access

---
title: Document Model: Data stored as self-contained JSON/XML documents, optimized for one-to-many tree-structured data and locality of access
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Layered Data Model Abstraction: Each layer in a system represents data in terms of the layer below it, hiding complexity via a clean interface — from real-world objects down to bytes on disk

---
title: Layered Data Model Abstraction: Each layer in a system represents data in terms of the layer below it, hiding complexity via a clean interface — from real-world objects down to bytes on disk
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Relational Model: Data organized into relations (tables) of unordered tuples (rows), designed to hide internal storage representation behind a clean querying interface

---
title: Relational Model: Data organized into relations (tables) of unordered tuples (rows), designed to hide internal storage representation behind a clean querying interface
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Schema-on-Read vs Schema-on-Write: The distinction between document databases (schema interpreted at read time) and relational databases (schema enforced at write time)

---
title: Schema-on-Read vs Schema-on-Write: The distinction between document databases (schema interpreted at read time) and relational databases (schema enforced at write time)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
