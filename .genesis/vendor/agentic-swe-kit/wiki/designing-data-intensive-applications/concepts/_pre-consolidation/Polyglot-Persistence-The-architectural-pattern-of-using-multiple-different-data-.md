---
title: Polyglot Persistence: The architectural pattern of using multiple different data storage technologies in one application, each chosen for its specific use-case fit
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Polyglot Persistence: The architectural pattern of using multiple different data storage technologies in one application, each chosen for its specific use-case fit
