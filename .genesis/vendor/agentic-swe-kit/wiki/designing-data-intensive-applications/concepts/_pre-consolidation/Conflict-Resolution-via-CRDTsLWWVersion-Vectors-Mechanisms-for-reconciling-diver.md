---
title: Conflict Resolution via CRDTs/LWW/Version Vectors: Mechanisms for reconciling divergent replica state, including last-write-wins, merge functions, and version vectors to track causal dependencies
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Conflict Resolution via CRDTs/LWW/Version Vectors: Mechanisms for reconciling divergent replica state, including last-write-wins, merge functions, and version vectors to track causal dependencies
