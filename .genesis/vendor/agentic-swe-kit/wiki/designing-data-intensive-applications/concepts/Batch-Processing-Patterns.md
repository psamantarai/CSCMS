...
## Dataflow Graph / DAG Execution Model: Representing batch jobs as directed acyclic graphs of operators with explicit data dependencies, enabling optimized scheduling and avoiding unnecessary materialization

---
title: Dataflow Graph / DAG Execution Model: Representing batch jobs as directed acyclic graphs of operators with explicit data dependencies, enabling optimized scheduling and avoiding unnecessary materialization
created: 2026-05-12
updated: 2026-05-12
type: concept
...
## Lambda Architecture / Reprocessing Pattern: Maintaining a batch layer for recomputing outputs from raw data alongside a serving layer, enabling correction of bugs and schema changes by replaying immutable input logs

---
title: Lambda Architecture / Reprocessing Pattern: Maintaining a batch layer for recomputing outputs from raw data alongside a serving layer, enabling correction of bugs and schema changes by replaying immutable input logs
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## MapReduce Programming Model: A two-phase distributed batch pattern (map to emit key-value pairs, reduce to aggregate by key) enabling fault-tolerant parallel processing across commodity hardware

---
title: MapReduce Programming Model: A two-phase distributed batch pattern (map to emit key-value pairs, reduce to aggregate by key) enabling fault-tolerant parallel processing across commodity hardware
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Online/Batch/Stream Trichotomy: A classification of data processing systems into services (request/response, latency-sensitive), batch processors (offline, throughput-optimized, fixed input), and stream processors (near-real-time, event-driven)

---
title: Online/Batch/Stream Trichotomy: A classification of data processing systems into services (request/response, latency-sensitive), batch processors (offline, throughput-optimized, fixed input), and stream processors (near-real-time, event-driven)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Working Set vs. Sort-Merge Trade-off: Choosing between in-memory hash aggregation (fast when working set fits in RAM) and sort-based aggregation (disk-friendly, sequential I/O, scales beyond memory)

---
title: Working Set vs. Sort-Merge Trade-off: Choosing between in-memory hash aggregation (fast when working set fits in RAM) and sort-based aggregation (disk-friendly, sequential I/O, scales beyond memory)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
