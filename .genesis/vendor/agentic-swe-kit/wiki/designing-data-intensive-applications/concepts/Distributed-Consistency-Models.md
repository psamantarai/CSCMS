...
## Consensus Abstraction: A general-purpose distributed primitive requiring all nodes to agree on a value, used to implement leader election, atomic commits, and other coordination tasks reliably despite faults

---
title: Consensus Abstraction: A general-purpose distributed primitive requiring all nodes to agree on a value, used to implement leader election, atomic commits, and other coordination tasks reliably despite faults
created: 2026-05-12
updated: 2026-05-12
type: concept
...
## Eventual Consistency (Convergence): A weak guarantee that all replicas will converge to the same value if writes stop, but provides no bound on when convergence occurs or what reads may return in the interim

---
title: Eventual Consistency (Convergence): A weak guarantee that all replicas will converge to the same value if writes stop, but provides no bound on when convergence occurs or what reads may return in the interim
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Linearizability: A consistency model that makes a distributed system appear as if there is only one copy of the data, with all operations atomic and reads always returning the most recent write (a recency guarantee)

---
title: Linearizability: A consistency model that makes a distributed system appear as if there is only one copy of the data, with all operations atomic and reads always returning the most recent write (a recency guarantee)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Transaction Isolation vs. Distributed Consistency: A conceptual separation distinguishing race-condition avoidance (isolation) from replica-state coordination under delays and faults (distributed consistency)

---
title: Transaction Isolation vs. Distributed Consistency: A conceptual separation distinguishing race-condition avoidance (isolation) from replica-state coordination under delays and faults (distributed consistency)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
