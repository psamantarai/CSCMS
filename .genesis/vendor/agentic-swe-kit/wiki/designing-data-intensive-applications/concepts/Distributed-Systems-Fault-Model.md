...
## Non-Byzantine Fault Assumption: This chapter assumes nodes may crash or behave erratically but do not deliberately lie or send maliciously crafted messages — simplifying the fault model

---
title: Non-Byzantine Fault Assumption: This chapter assumes nodes may crash or behave erratically but do not deliberately lie or send maliciously crafted messages — simplifying the fault model
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Partial Failure Model: In distributed systems, some components fail unpredictably while others keep working, producing non-deterministic outcomes unlike the binary fail/work model of single-node computers

---
title: Partial Failure Model: In distributed systems, some components fail unpredictably while others keep working, producing non-deterministic outcomes unlike the binary fail/work model of single-node computers
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
