...
## Backpressure Mechanism: When consumers are slower than producers, the system blocks producers rather than dropping messages or growing unbounded queues (as Unix pipes and TCP implement)

---
title: Backpressure Mechanism: When consumers are slower than producers, the system blocks producers rather than dropping messages or growing unbounded queues (as Unix pipes and TCP implement)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
## Lambda / Streaming-Batch Duality: Stream processing is the unbounded, continuously-processed counterpart to batch processing, with analogous concepts (events ↔ records, topics ↔ files)

---
title: Lambda / Streaming-Batch Duality: Stream processing is the unbounded, continuously-processed counterpart to batch processing, with analogous concepts (events ↔ records, topics ↔ files)
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Message Broker Pattern: A centralized, durable intermediary (e.g. Kafka, RabbitMQ) buffers messages between producers and consumers, tolerating client disconnects and providing replay

---
title: Message Broker Pattern: A centralized, durable intermediary (e.g. Kafka, RabbitMQ) buffers messages between producers and consumers, tolerating client disconnects and providing replay
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
...
## Publish-Subscribe Model: Producers emit events to named topics; multiple consumers independently subscribe and process those events, decoupling producers from consumers

---
title: Publish-Subscribe Model: Producers emit events to named topics; multiple consumers independently subscribe and process those events, decoupling producers from consumers
created: 2026-05-12
updated: 2026-05-12
type: concept
tags: [phase-1, designing-data-intensive-applications, concept]
