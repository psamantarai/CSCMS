---
title: Performance-Encapsulation Principle: Performance concerns around data storage are real but must be encapsulated at the low-level boundary, not allowed to shape overall architecture
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Performance-Encapsulation Principle: Performance concerns around data storage are real but must be encapsulated at the low-level boundary, not allowed to shape overall architecture
