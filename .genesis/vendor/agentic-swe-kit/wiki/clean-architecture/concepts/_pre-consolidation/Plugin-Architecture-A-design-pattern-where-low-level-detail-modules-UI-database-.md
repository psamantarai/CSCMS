---
title: Plugin Architecture: A design pattern where low-level detail modules (UI, database, devices) are plugged into high-level policy modules, making high-level code unaware of low-level implementations
created: 2026-05-12
updated: 2026-05-12
type: concept
