---
title: Périphérique Anti-Pattern: Placing all infrastructure code in one source tree allows infrastructure components to call each other directly, bypassing the domain entirely
created: 2026-05-12
updated: 2026-05-12
type: concept
