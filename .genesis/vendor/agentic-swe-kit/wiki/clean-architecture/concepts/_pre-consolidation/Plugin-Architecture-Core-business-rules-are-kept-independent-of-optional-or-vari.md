---
title: Plugin Architecture: Core business rules are kept independent of optional or variable components (GUI, database, frameworks) which plug into the core rather than being coupled to it
created: 2026-05-12
updated: 2026-05-12
type: concept
