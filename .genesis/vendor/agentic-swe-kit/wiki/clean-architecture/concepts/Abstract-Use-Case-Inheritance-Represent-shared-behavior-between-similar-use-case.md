---
title: Abstract Use Case Inheritance: Represent shared behavior between similar use cases as an abstract use case, implemented via abstract classes in a shared component that concrete use cases inherit from
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Abstract Use Case Inheritance: Represent shared behavior between similar use cases as an abstract use case, implemented via abstract classes in a shared component that concrete use cases inherit from
