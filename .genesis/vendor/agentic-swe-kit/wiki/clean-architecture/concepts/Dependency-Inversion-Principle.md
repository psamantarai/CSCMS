---
title: Dependency Inversion Principle (DIP): Source code dependencies should refer only to abstractions, not concretions, so that volatile implementations can change without affecting high-level policy
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Dependency Inversion Principle (DIP): Source code dependencies should refer only to abstractions, not concretions, so that volatile implementations can change without affecting high-level policy
...
# Dependency Inversion Principle (applied at boundaries): Using interfaces and polymorphism to make source code dependencies oppose the flow of control, enabling inner layers to call outer layer behavior without naming outer layer types
