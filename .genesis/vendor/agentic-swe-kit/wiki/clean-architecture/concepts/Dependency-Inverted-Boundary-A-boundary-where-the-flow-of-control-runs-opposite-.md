---
title: Dependency-Inverted Boundary: A boundary where the flow of control runs opposite to compile-time dependencies — achieved via a polymorphic interface so the supervisor can invoke applications without knowing anything about them
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Dependency-Inverted Boundary: A boundary where the flow of control runs opposite to compile-time dependencies — achieved via a polymorphic interface so the supervisor can invoke applications without knowing anything about them
