---
title: Local Process Boundary: Separate address spaces on the same processor, communicating via OS facilities (sockets, mailboxes, message queues); moderately expensive
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Local Process Boundary: Separate address spaces on the same processor, communicating via OS facilities (sockets, mailboxes, message queues); moderately expensive
