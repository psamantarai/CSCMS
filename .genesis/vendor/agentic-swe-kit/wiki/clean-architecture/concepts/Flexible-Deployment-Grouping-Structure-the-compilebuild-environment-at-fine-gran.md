---
title: Flexible Deployment Grouping: Structure the compile/build environment at fine granularity (per-actor, per-layer components) while reserving the right to combine deliverables into coarser groups at deploy time
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Flexible Deployment Grouping: Structure the compile/build environment at fine granularity (per-actor, per-layer components) while reserving the right to combine deliverables into coarser groups at deploy time
