---
title: Use-Case Boundary Abstraction: Defining each business use case by its complete input data structure and output data structure, allowing the use case to execute independently of how the UI collects or presents that data
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Use-Case Boundary Abstraction: Defining each business use case by its complete input data structure and output data structure, allowing the use case to execute independently of how the UI collects or presents that data
