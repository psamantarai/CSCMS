...
# Interface Segregation Principle (ISP): Users should not be forced to depend on interfaces they do not use; split fat interfaces into smaller, role-specific ones
