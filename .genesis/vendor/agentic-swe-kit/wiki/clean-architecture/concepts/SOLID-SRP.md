---
title: Actor-based Cohesion: Cohesion is defined by grouping code that serves the same actor, not merely code that 'does one thing' functionally
created: 2026-05-12
updated: 2026-05-12
type: concept
...
## Actor based Cohesion

# Actor-based Cohesion: Cohesion is defined by grouping code that serves the same actor, not merely code that 'does one thing' functionally
...
# Facade Pattern for SRP: A thin EmployeeFacade class instantiates and delegates to separate actor-aligned classes, reducing cognitive overhead while maintaining separation
...
# Single Responsibility Principle (SRP): A module should be responsible to one, and only one, actor — a group of stakeholders who require a particular change
