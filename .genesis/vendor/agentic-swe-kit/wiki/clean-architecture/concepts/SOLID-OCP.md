---
title: Directional Dependency Control: Using interfaces and abstractions to invert dependency arrows so they point toward the components that must be protected from change
created: 2026-05-12
updated: 2026-05-12
type: concept
...
## Directional Dependency Control

# Directional Dependency Control: Using interfaces and abstractions to invert dependency arrows so they point toward the components that must be protected from change
...
## Information Hiding via

# Information Hiding via Interface Segregation: Introducing interfaces not just to invert dependencies but to prevent transitive dependencies from leaking internals of one component into another
...
## Protection Hierarchy A

# Protection Hierarchy: A component dependency structure where higher-level (more central) components are shielded from change by having lower-level components depend on them, not the reverse
