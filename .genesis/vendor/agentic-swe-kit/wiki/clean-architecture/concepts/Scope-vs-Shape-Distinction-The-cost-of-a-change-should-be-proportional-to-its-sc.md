---
title: Scope vs. Shape Distinction: The cost of a change should be proportional to its scope (how much changes), not its shape (how well it fits the current architecture); mismatched shape is the root cause of escalating development costs
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Scope vs. Shape Distinction: The cost of a change should be proportional to its scope (how much changes), not its shape (how well it fits the current architecture); mismatched shape is the root cause of escalating development costs
