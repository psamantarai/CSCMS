---
title: Behavior vs. Architecture Duality: Software has two values — behavior (what it does now) and architecture (how easy it is to change); both must be maintained, but architecture is the greater long-term value
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Behavior vs. Architecture Duality: Software has two values — behavior (what it does now) and architecture (how easy it is to change); both must be maintained, but architecture is the greater long-term value
