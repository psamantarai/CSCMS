---
title: Clean Architecture: A concentric-layer system architecture where source code dependencies point only inward, separating entities, use cases, interface adapters, and frameworks/drivers
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Clean Architecture: A concentric-layer system architecture where source code dependencies point only inward, separating entities, use cases, interface adapters, and frameworks/drivers
...
# Interface Adapters Layer: The layer that converts data between the format convenient for use cases/entities and the format required by external agencies like databases or UIs
