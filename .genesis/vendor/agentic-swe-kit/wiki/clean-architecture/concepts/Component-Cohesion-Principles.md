...
# Component Cohesion Tension Triangle: A three-vertex tension diagram showing REP, CCP, and CRP as opposing forces — REP and CCP are inclusive (make components larger), CRP is exclusive (makes components smaller), and good architecture navigates the balance
...
## REP ReuseRelease Equivalence

# REP (Reuse/Release Equivalence Principle): The granule of reuse must equal the granule of release — classes grouped into a component must share a cohesive theme and be releasable together under the same version and documentation
