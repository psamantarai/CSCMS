---
title: Directed Acyclic Graph of Policy Components: Components containing same-level policies form nodes; compile-time dependencies form directed edges always pointing from lower-level to higher-level components
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Directed Acyclic Graph of Policy Components: Components containing same-level policies form nodes; compile-time dependencies form directed edges always pointing from lower-level to higher-level components
