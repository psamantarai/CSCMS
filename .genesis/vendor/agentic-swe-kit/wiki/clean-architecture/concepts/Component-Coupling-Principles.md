---
title: Acyclic Dependencies Principle (ADP): The component dependency graph must be a directed acyclic graph (DAG); no cycles allowed, or all components in the cycle collapse into one unreleasable unit
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Acyclic Dependencies Principle (ADP): The component dependency graph must be a directed acyclic graph (DAG); no cycles allowed, or all components in the cycle collapse into one unreleasable unit
...
# Stable Abstractions Principle (SAP): A component should be as abstract as it is stable; stable components should be abstract, and unstable components should be concrete
...
# Stable Dependencies Principle (SDP): Components should depend in the direction of stability; a component should only depend on components that are more stable than itself
