---
title: Abstract Factory Pattern: A creational pattern that isolates the source code dependency on a concrete object's constructor behind an abstract factory interface, keeping the abstract side of the boundary clean
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Abstract Factory Pattern: A creational pattern that isolates the source code dependency on a concrete object's constructor behind an abstract factory interface, keeping the abstract side of the boundary clean
