...
# Critical Business Rules: Rules that make or save the business money irrespective of automation — they would exist even if executed manually
...
# Entity: A software object that binds Critical Business Rules and Critical Business Data together in a single, isolated module free from UI, DB, and framework concerns
...
# Use Case: An application-specific business rule object that specifies inputs, outputs, and processing steps, controlling when and how Entities are invoked
