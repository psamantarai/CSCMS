---
title: Dependency-Normal Boundary: A boundary where compile-time dependencies align with the flow of control — applications depend on the supervisor, and control flows from applications to supervisor
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Dependency-Normal Boundary: A boundary where compile-time dependencies align with the flow of control — applications depend on the supervisor, and control flows from applications to supervisor
