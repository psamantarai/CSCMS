---
title: D Metric (Distance from Main Sequence): D = |A + I - 1|, measuring how far a component deviates from the Main Sequence; values near 0 are ideal, values near 1 indicate architectural problems
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# D Metric (Distance from Main Sequence): D = |A + I - 1|, measuring how far a component deviates from the Main Sequence; values near 0 are ideal, values near 1 indicate architectural problems
...
# Main Sequence: The ideal locus of component positions on the Abstractness-Instability graph, connecting (A=1, I=0) and (A=0, I=1), representing the optimal balance between abstraction and stability
