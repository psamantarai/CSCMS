---
title: Defer Decisions Framework: Shape the system so that the choice of database, web framework, deployment mechanism, and other details can be postponed until maximum information is available
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Defer Decisions Framework: Shape the system so that the choice of database, web framework, deployment mechanism, and other details can be postponed until maximum information is available
