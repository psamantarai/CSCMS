---
title: One-Dimensional Boundary (Strategy Pattern): Use a single interface to invert dependency in one direction, setting the stage for a full boundary without the cost of reciprocal isolation
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# One-Dimensional Boundary (Strategy Pattern): Use a single interface to invert dependency in one direction, setting the stage for a full boundary without the cost of reciprocal isolation
