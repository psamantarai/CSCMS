...
# Wiki Schema — Modular Architecture

## Domain
Engineering knowledge extracted from Phase 1 study: Modular Architecture.
...
- Raw source: `output/extracts/clean-architecture/` — immutable, never modify

## Tag Taxonomy
- phase-1: all pages in this wiki
- clean-architecture: all pages in this wiki
