...
## Pattern Selection Framework Decision logic mapping task properties needs private
...
## Planning Pattern Agent explicitly decomposes a complex task into ordered steps b
...
## RAG Pattern Agent retrieves relevant chunks from a knowledge base before generat
...
## Reflection Pattern Agent critiques its own output before returning it using a se
...
## Tool Use Pattern Agent calls external functions search calculator run code send
