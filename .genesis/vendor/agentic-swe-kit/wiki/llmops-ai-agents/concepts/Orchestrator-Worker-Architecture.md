...
## Context Bus Message Bus a shared publishsubscribe context store that decouples a
...
## Orchestrator Worker Decomposition one planner agent breaks a complex problem int
...
## Sequential Gate Pattern ordering dependent agents so compliancevalidation agents
...
## Span of Control Principle An orchestrator managing 5 specialists is more reliabl
...
## WorkTask Contract a typed dataclass defining task id worker type query shared co
