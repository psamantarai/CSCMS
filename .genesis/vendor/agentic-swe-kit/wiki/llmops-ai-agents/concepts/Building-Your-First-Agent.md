...
## Constraint Surface Definition A stable rarely changed specification of what the
...
## Hybrid Retrieval Pipeline BM25 Dense RRF Combine sparse BM25 and dense embedding
...
## Job To Be Done JTBD Define the agents purpose in plain English by specifying who
...
## QueryTrace Schema A structured per query log capturing retrieval scores rerankin
...
## Three Agent Patterns A decision framework for first agents Single Agent RAG stat
...
## Three Level Evaluation Plan Evaluate agents at component level does each piece w
