...
## 5 Coordination Questions Framework A checklist task decomposition communication
...
## Event DrivenReactive Pattern Independent agents that respond to events rather th
...
## Hierarchical Pattern Nested orchestrators arranged like an org chart for enterpr
...
## Orchestrator Worker Pattern One orchestrator decomposes a task and delegates sub
...
## Parallel Fan OutFan In Pattern A task is split into independent subtasks execute
...
## Sequential Pipeline Pattern Agents arranged as an assembly line where each stage
