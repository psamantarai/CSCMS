---
title: Reciprocal Rank Fusion (RRF): A rank-merging algorithm scoring each document as 1/(k+rank) across retrieval methods, boosting confidence when both sparse and dense agree
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Reciprocal Rank Fusion (RRF): A rank-merging algorithm scoring each document as 1/(k+rank) across retrieval methods, boosting confidence when both sparse and dense agree
