---
title: Golden Dataset: A curated, human-validated set of 100-500 test vectors (query + expected output + metadata) representing the source of truth for agent behavior, versioned and monitored for staleness
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Golden Dataset: A curated, human-validated set of 100-500 test vectors (query + expected output + metadata) representing the source of truth for agent behavior, versioned and monitored for staleness
