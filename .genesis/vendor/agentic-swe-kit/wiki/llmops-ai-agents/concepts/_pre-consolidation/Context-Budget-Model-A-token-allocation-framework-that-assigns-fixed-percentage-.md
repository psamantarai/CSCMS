---
title: Context Budget Model: A token-allocation framework that assigns fixed percentage budgets to each context component (system prompt first/non-negotiable, ~40% to retrieved docs, ~20% to tool results, remainder to conversation history) with recency-first pruning
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Context Budget Model: A token-allocation framework that assigns fixed percentage budgets to each context component (system prompt first/non-negotiable, ~40% to retrieved docs, ~20% to tool results, remainder to conversation history) with recency-first pruning
