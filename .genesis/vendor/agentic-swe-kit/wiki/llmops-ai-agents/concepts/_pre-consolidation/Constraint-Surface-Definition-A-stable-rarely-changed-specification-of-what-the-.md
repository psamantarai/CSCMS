---
title: Constraint Surface Definition: A stable, rarely-changed specification of what the agent can observe, what actions it can take, and what it is forbidden from doing — distinct from the code that implements it
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Constraint Surface Definition: A stable, rarely-changed specification of what the agent can observe, what actions it can take, and what it is forbidden from doing — distinct from the code that implements it
