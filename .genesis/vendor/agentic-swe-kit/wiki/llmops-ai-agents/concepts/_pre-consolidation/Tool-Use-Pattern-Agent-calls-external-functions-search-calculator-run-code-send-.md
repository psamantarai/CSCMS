---
title: Tool Use Pattern: Agent calls external functions (search, calculator, run_code, send_email) to extend beyond LLM knowledge, executing structured tool calls in a loop until a final answer is ready
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Tool Use Pattern: Agent calls external functions (search, calculator, run_code, send_email) to extend beyond LLM knowledge, executing structured tool calls in a loop until a final answer is ready
