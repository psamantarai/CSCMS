---
title: Shadow Mode Deployment: Running a new agent in parallel with the production agent to validate agreement before full cutover
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Shadow Mode Deployment: Running a new agent in parallel with the production agent to validate agreement before full cutover
