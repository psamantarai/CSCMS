---
title: Context Bus (Message Bus): a shared publish/subscribe context store that decouples agents from each other, letting each publish its output and read others' outputs without direct coupling
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Context Bus (Message Bus): a shared publish/subscribe context store that decouples agents from each other, letting each publish its output and read others' outputs without direct coupling
