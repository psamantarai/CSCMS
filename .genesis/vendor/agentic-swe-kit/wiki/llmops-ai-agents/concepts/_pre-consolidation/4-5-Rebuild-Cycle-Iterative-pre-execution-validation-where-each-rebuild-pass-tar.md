---
title: 4-5 Rebuild Cycle: Iterative pre-execution validation where each rebuild pass targets a distinct error class (breaking changes, referential integrity, simulation failures, performance, permissions) before presenting to humans
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# 4-5 Rebuild Cycle: Iterative pre-execution validation where each rebuild pass targets a distinct error class (breaking changes, referential integrity, simulation failures, performance, permissions) before presenting to humans
