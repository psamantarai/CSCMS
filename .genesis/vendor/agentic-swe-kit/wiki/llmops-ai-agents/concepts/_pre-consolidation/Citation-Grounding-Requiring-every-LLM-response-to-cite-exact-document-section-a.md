---
title: Citation Grounding: Requiring every LLM response to cite exact document, section, and page number so users can verify and update sources
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Citation Grounding: Requiring every LLM response to cite exact document, section, and page number so users can verify and update sources
