---
title: Client Isolation Layer: Per-client policy objects enforce tool allowlists, data residency, concurrent workflow limits, and audit levels before any request reaches execution infrastructure
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Client Isolation Layer: Per-client policy objects enforce tool allowlists, data residency, concurrent workflow limits, and audit levels before any request reaches execution infrastructure
