---
title: QueryTrace Schema: A structured per-query log capturing retrieval scores, reranking scores, token counts, latency, citations, and fallback status — enabling deterministic replay and debugging of any failure
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# QueryTrace Schema: A structured per-query log capturing retrieval scores, reranking scores, token counts, latency, citations, and fallback status — enabling deterministic replay and debugging of any failure
