---
title: Observable Agent Pattern (Spans + Traces): Every agent decision emits structured OpenTelemetry spans capturing what was decided, why, confidence level, and supporting evidence for post-hoc debuggability
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Observable Agent Pattern (Spans + Traces): Every agent decision emits structured OpenTelemetry spans capturing what was decided, why, confidence level, and supporting evidence for post-hoc debuggability
