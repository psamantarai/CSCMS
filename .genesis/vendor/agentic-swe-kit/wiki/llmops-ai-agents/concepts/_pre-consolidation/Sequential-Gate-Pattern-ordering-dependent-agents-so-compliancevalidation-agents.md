---
title: Sequential Gate Pattern: ordering dependent agents so compliance/validation agents run only after upstream agents publish results, enforcing data-dependency constraints without explicit orchestration logic
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Sequential Gate Pattern: ordering dependent agents so compliance/validation agents run only after upstream agents publish results, enforcing data-dependency constraints without explicit orchestration logic
