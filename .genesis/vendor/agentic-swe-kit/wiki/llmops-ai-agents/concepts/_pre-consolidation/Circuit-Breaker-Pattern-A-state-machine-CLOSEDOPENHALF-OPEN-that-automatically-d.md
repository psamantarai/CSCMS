---
title: Circuit Breaker Pattern: A state machine (CLOSED→OPEN→HALF_OPEN) that automatically disables a misbehaving agent and routes traffic away until recovery is confirmed
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Circuit Breaker Pattern: A state machine (CLOSED→OPEN→HALF_OPEN) that automatically disables a misbehaving agent and routes traffic away until recovery is confirmed
