---
title: Autonomous Coding Agent Loop: Clone → Analyze → Plan → Implement → Verify (run tests) → Create PR → Await human review, with rollback at any failure point
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Autonomous Coding Agent Loop: Clone → Analyze → Plan → Implement → Verify (run tests) → Create PR → Await human review, with rollback at any failure point
