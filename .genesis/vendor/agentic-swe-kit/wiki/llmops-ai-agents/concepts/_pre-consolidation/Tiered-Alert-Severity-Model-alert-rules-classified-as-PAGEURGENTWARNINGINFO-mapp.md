---
title: Tiered Alert Severity Model: alert rules classified as PAGE/URGENT/WARNING/INFO mapped to escalation paths (PagerDuty → Jira ticket → log warning → log info)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Tiered Alert Severity Model: alert rules classified as PAGE/URGENT/WARNING/INFO mapped to escalation paths (PagerDuty → Jira ticket → log warning → log info)
