---
title: Structured Logging Schema: all log entries are JSON objects with a consistent schema (timestamp, trace_id, span_id, level, message, tags) enabling machine-parseable querying
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Structured Logging Schema: all log entries are JSON objects with a consistent schema (timestamp, trace_id, span_id, level, message, tags) enabling machine-parseable querying
