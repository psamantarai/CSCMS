---
title: Guardrail Layer Architecture: A three-layer wrapper around agent logic with independent input guards, output guards, and tool-call guards—each capable of blocking independently
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Guardrail Layer Architecture: A three-layer wrapper around agent logic with independent input guards, output guards, and tool-call guards—each capable of blocking independently
