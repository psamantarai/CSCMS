---
title: Safety Threshold Rule: require agreement from 2+ agents before taking the highest-severity action, downgrading single-agent extremes to reduce false positives
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Safety Threshold Rule: require agreement from 2+ agents before taking the highest-severity action, downgrading single-agent extremes to reduce false positives
