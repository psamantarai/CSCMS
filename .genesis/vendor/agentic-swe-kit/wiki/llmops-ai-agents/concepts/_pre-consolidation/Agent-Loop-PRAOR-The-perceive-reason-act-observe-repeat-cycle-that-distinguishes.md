---
title: Agent Loop (PRAOR): The perceive → reason → act → observe → repeat cycle that distinguishes agents from single LLM calls
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Agent Loop (PRAOR): The perceive → reason → act → observe → repeat cycle that distinguishes agents from single LLM calls
