---
title: Per-Agent Timeout: apply timeouts individually to each parallel agent so fast agents return immediately while slow agents are awaited independently
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Per-Agent Timeout: apply timeouts individually to each parallel agent so fast agents return immediately while slow agents are awaited independently
