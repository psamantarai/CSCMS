---
title: Pattern Selection Framework: Decision logic mapping task properties (needs private knowledge, needs APIs, has multiple steps, accuracy-critical) to the appropriate subset of the four patterns
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Pattern Selection Framework: Decision logic mapping task properties (needs private knowledge, needs APIs, has multiple steps, accuracy-critical) to the appropriate subset of the four patterns
