---
title: Query-to-Structure Parsing: Extracting structured metadata (grade level, domain, concept) from natural language queries to enable deterministic filtering with semantic fallback
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Query-to-Structure Parsing: Extracting structured metadata (grade level, domain, concept) from natural language queries to enable deterministic filtering with semantic fallback
