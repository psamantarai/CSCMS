---
title: Confidence-Weighted Voting: merge agent verdicts by scoring each as (verdict_weight × confidence), aggregating per verdict type, and selecting the highest aggregate
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Confidence-Weighted Voting: merge agent verdicts by scoring each as (verdict_weight × confidence), aggregating per verdict type, and selecting the highest aggregate
