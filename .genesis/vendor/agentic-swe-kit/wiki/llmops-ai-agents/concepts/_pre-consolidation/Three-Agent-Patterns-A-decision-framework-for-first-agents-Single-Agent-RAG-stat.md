---
title: Three Agent Patterns: A decision framework for first agents — Single-Agent RAG (static knowledge, independent queries), Conversational Router (multi-turn state, intent branching), and Narrow Action Agent (1-3 tool calls with sequential branching logic)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Three Agent Patterns: A decision framework for first agents — Single-Agent RAG (static knowledge, independent queries), Conversational Router (multi-turn state, intent branching), and Narrow Action Agent (1-3 tool calls with sequential branching logic)
