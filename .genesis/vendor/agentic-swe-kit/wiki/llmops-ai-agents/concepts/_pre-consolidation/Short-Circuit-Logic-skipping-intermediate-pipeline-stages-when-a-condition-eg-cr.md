---
title: Short-Circuit Logic: skipping intermediate pipeline stages when a condition (e.g., critical severity) makes them unnecessary, reducing latency
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Short-Circuit Logic: skipping intermediate pipeline stages when a condition (e.g., critical severity) makes them unnecessary, reducing latency
