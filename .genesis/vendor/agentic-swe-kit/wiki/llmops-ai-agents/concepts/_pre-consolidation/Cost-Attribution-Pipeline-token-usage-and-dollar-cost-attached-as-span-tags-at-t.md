---
title: Cost Attribution Pipeline: token usage and dollar cost attached as span tags at the LLM call level, enabling per-query, per-model, per-user cost breakdown
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Cost Attribution Pipeline: token usage and dollar cost attached as span tags at the LLM call level, enabling per-query, per-model, per-user cost breakdown
