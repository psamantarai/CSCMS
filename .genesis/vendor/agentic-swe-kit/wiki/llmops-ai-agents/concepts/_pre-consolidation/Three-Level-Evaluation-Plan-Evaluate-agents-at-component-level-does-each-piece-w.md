---
title: Three-Level Evaluation Plan: Evaluate agents at component level (does each piece work?), unit level (does each step produce sane output?), and end-to-end level (does the whole pipeline meet SLOs?)
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Three-Level Evaluation Plan: Evaluate agents at component level (does each piece work?), unit level (does each step produce sane output?), and end-to-end level (does the whole pipeline meet SLOs?)
