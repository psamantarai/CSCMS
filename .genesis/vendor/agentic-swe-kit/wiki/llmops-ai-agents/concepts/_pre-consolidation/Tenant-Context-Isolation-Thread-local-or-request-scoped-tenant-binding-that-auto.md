---
title: Tenant Context Isolation: Thread-local or request-scoped tenant binding that automatically filters all data access by tenant ID
created: 2026-05-12
updated: 2026-05-12
type: concept
...
# Tenant Context Isolation: Thread-local or request-scoped tenant binding that automatically filters all data access by tenant ID
