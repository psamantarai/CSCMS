...
## Agent Loop PRAOR The perceive reason act observe repeat cycle that distinguishes
...
## Agent vs LLM Call Distinction A plain LLM call is a stateless function input out
...
## Four Component Anatomy Every agent is composed of Sensors LLM Brain Actuators an
...
## Seven Agent Types taxonomy A classification of agents from simple reflex no memo
