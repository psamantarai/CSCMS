---
domain: LLMOps and AI Agents
book_slug: llmops-ai-agents
phase: 2
created: 2026-05-12
---

# Wiki Schema — LLMOps and AI Agents

## Domain
Engineering knowledge extracted from Phase 2 study: LLMOps and AI Agents.
...
- Raw source: `output/extracts/llmops-ai-agents/` — immutable, never modify

## Tag Taxonomy
- phase-2: all pages in this wiki
- llmops-ai-agents: all pages in this wiki
